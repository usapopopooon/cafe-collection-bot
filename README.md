...
Discordのカフェ機能、カード639種と共通画像2枚、サイト向け公開API、ヘルスAPI、CI、
...
季節限定風の飲み物と喫茶店のネタメニュー20種（飲み物16種・食べ物4種）の追加一覧と
画像制作記録は [docs/menu-additions-2026-09-20.md](docs/menu-additions-2026-09-20.md)
を参照してください。
...
ランキングはlevel-botの現在所属情報を正本としてBAN済み・退会済みユーザーを除外する。
BANイベントを受信できる場合は常設パネルを即時更新し、イベントを受信できない場合も
1分ごとの再取得で追従する。
